...
/**
 * Base implementation of ManageBillingAccount Interface.
 */
@Service( "manageBillingAccountService" )
public class ManageBillingAccountServiceImpl
	implements ManageBillingAccount
{

	/** The Constant logger. */
	private static final Logger LOGGER = LoggerFactory.getLogger( ManageBillingAccountServiceImpl.class );
	...
	{
		return manageBillingAccount.create( billingAccount );
	}
	...
	{
		return manageBillingAccount.credit( billingAccountID, currency, adjustment );
	}
	...
	{
		return manageBillingAccount.findAndGet( criteria );
	}
	...
	{
		manageBillingAccount.publish( billingAccountID, billingAccountStatus );
	}
	...
	{
		return manageBillingAccount.update( billingAccount, useCase );
	}
}
